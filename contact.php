    ...
    <?php
        ...
        <div class="header"  >
            ...
            <div class="row" style="max-width: 100%; height: 100%;"  >
                <div class="col-lg-6 col-md-12 header__content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-md-12">
                        <h3 class="contact--title">Vous avez une question ?</h3>
                        <p class="contact--description">
                           Vous voulez rentrer en contact avec l'équipe
                           <strong class="text--blue">Dev Forum</strong>.
                           Vous pouvez nous laisser un message et vous nous repondrons
                           dans <span class="text--blue"> les heures qui suivent</span>.
                        </p>
                        <form action="" id="contact-form" novalidate="novalidate">
                            <div class="form-group">
                                <input type="text" class="text-input" placeholder="Quel est votre nom ?" name="name">
                            </div>
                            <div class="form-group">
                                <input type="email" class="text-input" placeholder="Sur quelle addresse-email devons-nous repondre ?" name="email">
                            </div>
                            <div class="form-group">
                            <textarea class="text-input" placeholder="Quelle est votre question ?" rows="5" name="content"></textarea>
                            </div>
                            <div class="form-group">
                                <input type="text" class="text-input" placeholder="Combien font 5 - 10?" name="result">
                            </div>
                            <div class="form-group d-flex align-items-center justify-content-end">
                                <a class="btn btn--white btn--white-bold mr-2 go-back" href="#">Annuler </a>
                                <button class="btn btn-orange" id="contact-submit">Envoyer 
                        ...
                        <div class="contact--info">
                            <div class="contact--elements">
                                <ul class="contact--label-list">
                                                                        <li class="contact--label-item">
                                            <div class="row w-100">
                                                <span class="col-6">
                                                    <i class="fa fa-envelope"></i> Email:
                                                </span>
                                                <span class="col-6">
                                                   devforumtogo@gmail.com
                                                </span>
                                            </div>
                                        </li>
                                                                        <li class="contact--label-item">
