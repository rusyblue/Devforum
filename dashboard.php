...
session_start();
    ...
    include_once 'functions/addpost.class.php';
    $bbd = bbd();
    ...
    <main class="main-wrapper" id="root">
        ...
        <div class="posts" id="particles-js">
            ...
            <div class="tutorial-banner container">
                ...
                <div class="row" style="max-width: 100%;height: 100%" id="modfi2">
                    <div class="col-lg-6 col-md-12">
                        <div class="tutorial-header">
                            <h1 class="tutorial-header--title">Choisissez Votre théme de discussion</h1>
                    ...
                    <div class="col-lg-6 col-md-12 tutorial-illustration--wrapper">
                        <div class="tutorial-illustration">
                            <svg id="a47bc909-72c0-4996-baf1-6f4140acb8df" data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg" width="644.4629" height="569.05811"
                                ...
                                <path
                                    ...
                                    transform="translate(-277.76855 -165.47095)" fill="#e6e6e6" />
                                <path
                                    ...
                                    transform="translate(-277.76855 -165.47095)" fill="#fff" />
                                <path
                                ...
                                <path
                                    ...
                                    transform="translate(-277.76855 -165.47095)" fill="#2f2e41" />
                                ...
                                <path
                                    ...
                                    transform="translate(-277.76855 -165.47095)" fill="#a0616a" />
                                <path
                                ...
                                <path d="M921.23145,734.52905h-350a1,1,0,0,1,0-2h350a1,1,0,0,1,0,2Z"
                                    transform="translate(-277.76855 -165.47095)" fill="#ccc" />
                                <path
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 footer__top--icons">
                        ...
                        <ul class="footer--social--list footer__top--social-list ">
                            <li class="footer__top--social-item">
                                <a href="  " target="_blank" title="Page Facebook">
